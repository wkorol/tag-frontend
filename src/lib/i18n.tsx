...
const baseEn = {
    ...
    quoteForm: {
      ...
      fixedRouteBody: (route: string, price: number) => `${route} - fixed price ${price} PLN.`,
      fixedRouteCta: 'Book fixed price',
      fixedRouteHint: 'Use the fixed-price booking for the fastest confirmation.',
      fixedRouteDistance: (distance: number) => `Route distance: ${distance} km`,
      ...
      fixedRouteComputed: (price: number) => `Fixed price calculated: ${price} PLN`,
      fixedRouteFooter: (price: number) => `Book transfer - ${price} PLN`,
      longRouteTitle: 'Long route estimate',
      longRouteDistance: (distance: number) => `Distance: ${distance} km`,
      longRouteTaximeter: (price: number, rate: number) => `Standard estimate: ${price} PLN (${rate} PLN/km)`,
      longRouteProposed: (price: number) => `Our suggested price: ${price} PLN`,
      longRouteSavings: (percent: number) => `This is about ${percent}% less than the standard estimate`,
...
const translations = {
  ...
  pl: {
    ...
    quoteForm: {
      ...
      fixedRouteBody: (route: string, price: number) => `${route} - stała cena ${price} PLN.`,
      ...
      fixedRouteDistance: (distance: number) => `Dystans trasy: ${distance} km`,
      ...
      fixedRouteComputed: (price: number) => `Wyliczono stałą cenę: ${price} PLN`,
      fixedRouteFooter: (price: number) => `Zarezerwuj przejazd - ${price} PLN`,
      longRouteTitle: 'Długi dystans - orientacyjna wycena',
      longRouteDistance: (distance: number) => `Dystans: ${distance} km`,
      longRouteTaximeter: (price: number, rate: number) => `Szacunkowa cena standardowa: ${price} PLN (${rate} PLN/km)`,
      longRouteProposed: (price: number) => `Nasza propozycja: ${price} PLN`,
      longRouteSavings: (percent: number) => `To około ${percent}% mniej niż cena standardowa`,
  ...
  de: {
    ...
    quoteForm: {
      ...
      fixedRouteBody: (route: string, price: number) => `${route} - Festpreis ${price} PLN.`,
      ...
      fixedRouteComputed: (price: number) => `Festpreis berechnet: ${price} PLN`,
      fixedRouteFooter: (price: number) => `Transfer buchen - ${price} PLN`,
      longRouteTitle: 'Long route estimate',
      longRouteDistance: (distance: number) => `Distance: ${distance} km`,
      longRouteTaximeter: (price: number, rate: number) => `Standard estimate: ${price} PLN (${rate} PLN/km)`,
      longRouteProposed: (price: number) => `Our suggested price: ${price} PLN`,
