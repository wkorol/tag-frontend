...
import { u as useEurRate, p as preloadEurRate, f as formatEur, g as getApiBaseUrl } from './currency-DvMRQ8I8.mjs';
...
function AdminOrderPage() {
  ...
  const renderPrice = (value) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "leading-tight", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "min-h-[16px] text-xs text-slate-500", children: eurText ?? "" })
    ] });
  };
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white p-6 shadow-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
          ...
          /* @__PURE__ */ jsx(
            "span",
            {
              className: `inline-flex rounded-full px-3 py-1 text-xs font-medium ${statusStyles[order.status] ?? "bg-slate-100 text-slate-700"}`,
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-4 grid gap-4 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-slate-100 bg-slate-50 p-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
              ...
              " ",
              parsedNotes?.passengers ?? "—"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
              t.adminOrder.largeLuggage,
              " ",
              parsedNotes?.largeLuggage ?? "—"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
              t.adminOrder.pickupType,
              " ",
              parsedNotes?.pickupType ?? "—"
            ] }),
            parsedNotes?.signService && /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
              t.adminOrder.signService,
              " ",
              parsedNotes.signService === "sign" ? t.adminOrder.signServiceSign : t.adminOrder.signServiceSelf
            ] }),
            typeof parsedNotes?.signFee === "number" && parsedNotes.signFee > 0 && /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700 leading-tight", children: [
              /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "min-h-[16px] text-xs text-slate-500", children: formatEur(parsedNotes.signFee, eurRate) ?? "" })
            ] }),
            parsedNotes?.pickupType === "airport" && /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
              t.adminOrder.flightNumber,
              " ",
              order.flightNumber || "—"
            ] }),
            parsedNotes?.signText && /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
            ...
            parsedNotes?.notes && /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-700", children: [
              t.adminOrder.notes,
              " ",
              parsedNotes.notes
            ] })
