...
import { u as useI18n, y as getCountryAirportBySlug, z as getCountryAirportCountry, c as usePageTitle, l as localeToPath, t as trackCtaClick, r as requestScrollTo, e as trackNavClick, d as getRouteSlug, F as FloatingActions } from "../entry-server.mjs";
import { N as Navbar, T as TrustSection } from "./TrustSection-CXktLlh-.mjs";
import { NotFoundPage } from "./NotFoundPage-Cp7sBpFY.mjs";
import "lucide-react";
import "react";
...
function CountryAirportLanding() {
  ...
  const resolvedSlug = airportSlug != null ? airportSlug : slugFromPath;
  ...
  const destinations = (_d = (_c = (_b = t.pages) == null ? void 0 : _b.gdanskTaxi) == null ? void 0 : _c.examples) != null ? _d : [];
