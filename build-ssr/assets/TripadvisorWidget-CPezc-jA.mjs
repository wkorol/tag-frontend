...
function TripadvisorWidget({
  ...
  const locationId = locationIdProp || void 0 || "34104207";
  const uniq = uniqProp || void 0 || "444";
  const href = hrefProp || void 0 || "https://www.tripadvisor.com/Attraction_Review-g274725-d34104207-Reviews-Taxi_Airport_Gdansk-Gdansk_Pomerania_Province_Northern_Poland.html";
  const wtype = wtypeProp || void 0 || "cdsratingsonlywide";
  const border = borderProp != null ? borderProp : true;
  const shadow = typeof shadowProp === "boolean" ? shadowProp : null;
  const backgroundColor = backgroundColorProp || void 0 || null;
