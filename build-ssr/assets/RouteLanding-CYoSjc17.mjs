...
import { u as useI18n, c as usePageTitle, l as localeToPath, d as getRouteSlug, t as trackCtaClick, r as requestScrollTo, e as trackNavClick, b as getRoutePath, F as FloatingActions } from "../entry-server.mjs";
...
function RouteLanding({ title, description, route, examples, pricing }) {
  ...
  const seoParagraph = typeof ((_a = t.routeLanding) == null ? void 0 : _a.seoParagraph) === "function" ? t.routeLanding.seoParagraph(route) : (_b = fallbackSeoParagraphByLocale[locale]) != null ? _b : fallbackSeoParagraphByLocale.en;
  const pricingSubtitle = typeof ((_c = t.routeLanding) == null ? void 0 : _c.pricingSubtitle) === "function" ? t.routeLanding.pricingSubtitle(route) : (_d = fallbackPricingSubtitleByLocale[locale]) != null ? _d : fallbackPricingSubtitleByLocale.en;
  const orderLinks = [
    {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-12 bg-gray-50 border-t border-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-xl text-gray-900 mb-4", children: (_e = t.routeLanding.relatedRoutesTitle) != null ? _e : "Related routes" }),
        /* @__PURE__ */ jsx("div", { className: "grid gap-3 md:grid-cols-3", children: [
          { key: "airportTaxi", label: t.navbar.airportTaxi },
          { key: "airportSopot", label: t.navbar.airportSopot },
          { key: "airportGdynia", label: t.navbar.airportGdynia },
          { key: "taxiGdanskCity", label: (_g = (_f = t.cityTaxi) == null ? void 0 : _f.title) != null ? _g : "Taxi Gdańsk" },
          { key: "pricing", label: t.navbar.prices },
          { key: "countryLanding", label: (_i = (_h = t.countryLanding) == null ? void 0 : _h.title) != null ? _i : t.navbar.airportTaxi }
