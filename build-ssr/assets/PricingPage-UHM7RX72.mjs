...
import { u as useI18n, l as localeToPath, d as getRouteSlug, r as requestScrollTo, c as usePageTitle, f as trackFormOpen, t as trackCtaClick, e as trackNavClick, F as FloatingActions, h as scrollToId } from "../entry-server.mjs";
import { N as Navbar } from "./Navbar-BJLcl6ZC.mjs";
import { Pricing } from "./Pricing-DwIJSNH5.mjs";
import { Calculator, MapPin, X, Navigation } from "lucide-react";
import { d as distanceKm, i as isPointInsideGeoJson, c as cityPolygons, a as centerPolygons, Q as QuoteForm } from "./QuoteForm-BC7azLOT.mjs";
import { F as FIXED_PRICES } from "./fixedPricing-X_0fgxGY.mjs";
import { u as useEurRate, p as preloadEurRate, f as formatEur } from "./currency-Dq1_z9aO.mjs";
import { OrderForm } from "./OrderForm-gPj-Q5mt.mjs";
import { T as TrustSection } from "./TrustSection-DGIrAbM2.mjs";
import "react-dom/server";
import "react-router-dom/server.js";
import "./orderNotes-CLklzBys.mjs";
import "./api-Ck-Mugua.mjs";
import "./scrollLock-3BhfaRNM.mjs";
...
function PricingCalculator() {
  ...
  const formatFixedRouteDistance = (distance) => typeof t.quoteForm.fixedRouteDistance === "function" ? t.quoteForm.fixedRouteDistance(distance) : `Distance: ${distance} km`;
  ...
  const ensureDirectionsService = () => {
    ...
    if (!(google == null ? void 0 : google.maps)) {
      return null;
    }
  ...
  const ensurePlacesLibrary = async () => {
    ...
    const google = window.google;
    if (!((_a = google == null ? void 0 : google.maps) == null ? void 0 : _a.importLibrary)) {
      return null;
    }
  ...
  const geocodeByPlaceId = async (placeId) => {
    try {
      const google = window.google;
      if (!(google == null ? void 0 : google.maps)) return null;
      ...
      return new Promise((resolve) => {
        new google.maps.Geocoder().geocode({ placeId }, (results, status) => {
          var _a, _b;
          if (status !== "OK" || !((_b = (_a = results == null ? void 0 : results[0]) == null ? void 0 : _a.geometry) == null ? void 0 : _b.location)) {
            resolve(null);
            return;
          }
  ...
  const retrieveSuggestionPoint = async (placeId) => {
    ...
    try {
      ...
      const lat = typeof (location2 == null ? void 0 : location2.lat) === "function" ? location2.lat() : Number(location2 == null ? void 0 : location2.lat);
      const lon = typeof (location2 == null ? void 0 : location2.lng) === "function" ? location2.lng() : Number(location2 == null ? void 0 : location2.lng);
      ...
      try {
        ...
        const getPredictions = async (useBias) => {
          ...
          const request = {
            ...
            region: "pl",
            language: locale,
            sessionToken: sessionToken != null ? sessionToken : void 0
          };
          if (useBias) {
        ...
        const results = predictions.map((suggestion) => suggestion.placePrediction).filter((prediction) => prediction == null ? void 0 : prediction.placeId).map((prediction) => {
          var _a, _b, _c, _d, _e;
          const label = typeof ((_a = prediction == null ? void 0 : prediction.text) == null ? void 0 : _a.text) === "string" ? prediction.text.text : (_d = (_c = (_b = prediction == null ? void 0 : prediction.text) == null ? void 0 : _b.toString) == null ? void 0 : _c.call(_b)) != null ? _d : "";
          return {
            label,
            placeId: String((_e = prediction.placeId) != null ? _e : "")
          };
    ...
    const timer = window.setTimeout(async () => {
      ...
      const geocodeAddress = async (value) => {
        ...
        if (geocodeCache.current.has(key)) {
          return (_a2 = geocodeCache.current.get(key)) != null ? _a2 : null;
        }
        const lib = await ensurePlacesLibrary();
        if (!lib) {
          return null;
        ...
        const { suggestions } = await lib.AutocompleteSuggestion.fetchAutocompleteSuggestions(request);
        const prediction = Array.isArray(suggestions) ? (_b2 = suggestions[0]) == null ? void 0 : _b2.placePrediction : null;
        if (!(prediction == null ? void 0 : prediction.placeId)) {
        ...
        const resultInfo = await new Promise((resolve) => {
          directions.route(
            ...
            (result2, status) => {
              ...
              const meters = (_e2 = (_d2 = (_c2 = (_b2 = (_a2 = result2 == null ? void 0 : result2.routes) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.legs) == null ? void 0 : _c2[0]) == null ? void 0 : _d2.distance) == null ? void 0 : _e2.value;
              if (typeof meters !== "number" || !Number.isFinite(meters)) {
                resolve({ distance: null });
                return;
              }
              const overviewPath = (_g = (_f = result2 == null ? void 0 : result2.routes) == null ? void 0 : _f[0]) == null ? void 0 : _g.overview_path;
              const path = Array.isArray(overviewPath) ? overviewPath.map((point) => ({
                lat: typeof (point == null ? void 0 : point.lat) === "function" ? point.lat() : Number(point == null ? void 0 : point.lat),
                lon: typeof (point == null ? void 0 : point.lng) === "function" ? point.lng() : Number(point == null ? void 0 : point.lng)
      ...
      try {
        const pickup = pickupMode === "airport" ? (_a = await geocodeAddress(AIRPORT_GEOCODE_QUERY)) != null ? _a : AIRPORT_COORD : pickupPoint != null ? pickupPoint : await geocodeAddress(pickupAddress);
        const destination = destinationMode === "airport" ? (_b = await geocodeAddress(AIRPORT_GEOCODE_QUERY)) != null ? _b : AIRPORT_COORD : destinationPoint != null ? destinationPoint : await geocodeAddress(destinationAddress);
        ...
        const distance = (_c = routedDistanceResult == null ? void 0 : routedDistanceResult.km) != null ? _c : straightDistance;
        const distanceRounded = formatDistance(distance);
        const pickupInGdansk = isPointInsideGeoJson(pickup, cityPolygons.gdansk);
        const destinationInGdansk = isPointInsideGeoJson(destination, cityPolygons.gdansk);
        const pathStats = (routedDistanceResult == null ? void 0 : routedDistanceResult.path) ? getPathInsideStats(routedDistanceResult.path, (point) => isPointInsideGeoJson(point, cityPolygons.gdansk)) : null;
        ...
        const debugInfo = showDebug ? {
          ...
          routedDistance: (_d = routedDistanceResult == null ? void 0 : routedDistanceResult.km) != null ? _d : null,
          routeSource: (_e = routedDistanceResult == null ? void 0 : routedDistanceResult.source) != null ? _e : "none",
  ...
  const renderPrice = (value) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "min-w-[96px] text-right leading-tight", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "min-h-[16px] text-xs text-gray-500", children: eur != null ? eur : "" })
    ] });
  };
