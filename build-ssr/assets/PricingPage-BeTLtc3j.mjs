...
import { d as distanceKm, i as isPointInsideGeoJson, c as cityPolygons, a as centerPolygons, Q as QuoteForm } from "./QuoteForm-D7OJlkYc.mjs";
...
function PricingCalculator() {
  ...
  const geocodeByPlaceId = async (placeId) => {
    var _a;
    const google = window.google;
    if (!((_a = google == null ? void 0 : google.maps) == null ? void 0 : _a.Geocoder)) return null;
    return new Promise((resolve) => {
      new google.maps.Geocoder().geocode({ placeId }, (results, status) => {
        var _a2, _b;
        if (status !== "OK" || !((_b = (_a2 = results == null ? void 0 : results[0]) == null ? void 0 : _a2.geometry) == null ? void 0 : _b.location)) {
          resolve(null);
          return;
        }
