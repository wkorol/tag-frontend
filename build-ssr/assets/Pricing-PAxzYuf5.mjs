...
import { u as useI18n, i as trackPricingRouteSelect, j as trackPricingAction, T as TrustBar, k as trackVehicleSelect } from "../entry-server.mjs";
...
function Pricing({
  ...
  const pricingTable = /* @__PURE__ */ jsxs("div", { className: variant === "landing" ? "rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-slate-50 p-8 shadow-lg" : "", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-6 hidden sm:block", children: /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse text-sm", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { children: displayStandardRoutes.map((route, index) => {
        var _a, _b;
        return /* @__PURE__ */ jsxs("tr", { className: "odd:bg-white even:bg-slate-50", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "border border-slate-200 px-4 py-3 text-right", children: renderPriceWithEur((_a = displayBusRoutes[index]) == null ? void 0 : _a.priceDay) }),
          /* @__PURE__ */ jsx("td", { className: "border border-slate-200 px-4 py-3 text-right", children: renderPriceWithEur((_b = displayBusRoutes[index]) == null ? void 0 : _b.priceNight) })
        ] }, `${route.to}-${index}`);
      }) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "mt-6 space-y-4 sm:hidden", children: displayStandardRoutes.map((route, index) => {
      var _a, _b;
      return /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white p-4 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 grid grid-cols-2 gap-3 text-xs text-gray-600", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-slate-200 bg-slate-50 p-3", children: [
            ...
            renderPriceWithEur((_a = displayBusRoutes[index]) == null ? void 0 : _a.priceDay, "mt-1 text-sm font-semibold text-gray-900")
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-slate-200 bg-slate-50 p-3", children: [
            /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wide text-slate-500", children: t.pricing.tableBusNight }),
            /* @__PURE__ */ jsx("div", { className: "pricing-sunday-note mt-0.5 text-slate-400", children: t.pricing.sundayNote }),
            renderPriceWithEur((_b = displayBusRoutes[index]) == null ? void 0 : _b.priceNight, "mt-1 text-sm font-semibold text-gray-900")
          ] })
        ] })
