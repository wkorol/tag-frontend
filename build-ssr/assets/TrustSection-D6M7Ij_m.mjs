...
import { u as useI18n, D as getRouteKeyFromSlug, l as localeToPath, E as favicon, e as trackNavClick, b as getRoutePath, r as requestScrollTo, F as trackLocaleChange, d as getRouteSlug, C as localeToRootPath } from '../entry-server.mjs';
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-8 grid gap-4 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 flex w-full flex-col items-center px-2 py-2 sm:px-3", children: [
