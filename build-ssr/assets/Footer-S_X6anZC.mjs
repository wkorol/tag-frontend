      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm", children: [
          ...
          popularCityRoutes.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-[0.2em] text-gray-400", children: (_f = (_e = t.cityTaxi) == null ? void 0 : _e.cityRoutesTitle) != null ? _f : "Popular routes" }),
