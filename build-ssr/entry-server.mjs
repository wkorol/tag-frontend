...
const OrderForm = lazy(() => import('./assets/OrderForm-B0ym8K9Q.mjs').then((mod) => ({ default: mod.OrderForm })));
...
const OrderRoutePage = lazy(() => import('./assets/OrderRoutePage-D5UQqSN-.mjs').then((mod) => ({ default: mod.OrderRoutePage })));
const CustomOrderPage = lazy(() => import('./assets/OrderRoutePage-D5UQqSN-.mjs').then((mod) => ({ default: mod.CustomOrderPage })));
const PricingPage = lazy(() => import('./assets/PricingPage-Dcb14p7H.mjs').then((mod) => ({ default: mod.PricingPage })));
